...
install_service() {
    ...
    sudo apt-get install php7.0-mysql php7.0-curl php7.0-cli -y 
    sudo apt update
    sudo apt upgrade
    sudo apt install php7.0-fpm php7.0-common libapache2-mod-fcgid php7.0-cli -y
    sudo a2enmod proxy_fcgi setenvif && sudo a2enconf php7.0-fpm
    ...
    echo Apache service is $(systemctl status apache2)
    echo MYSQL service is $(systemctl status mysqld)
